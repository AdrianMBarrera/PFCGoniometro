...
function step1() {
	...
	GUI.Label(Rect(Screen.width-Screen.width/4+20, 100, 200, 30), "Articulacion inicial: ");
	GUI.Label(Rect(Screen.width-Screen.width/4+200, 100, 200, 30), restriction.initialArt);

	GUI.Label(Rect(Screen.width-Screen.width/4+20, 130, 200, 30), "Articulacion final: ");
	GUI.Label(Rect(Screen.width-Screen.width/4+200, 130, 200, 30), restriction.finalArt);
	
	GUI.Label(Rect(Screen.width-Screen.width/4+20 , 200, 200, 30), "Rotacion: ");
	...
	GUI.Label(Rect(Screen.width-Screen.width/4+20, 330, 200, 30), "Grados: ");
...
function step2() {
	...
	GUI.Label(Rect(Screen.width-Screen.width/4+20 , 160, 200, 30), "Posicion inicial: ");
